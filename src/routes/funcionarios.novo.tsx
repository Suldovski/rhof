...
import { formatCpf, formatCpfPartial } from "@/lib/employees";
          ...
          <CardContent className="space-y-3">
            ...
            {form.dependentes.map((d) => (
              <div key={d.id} className="grid gap-2 rounded-md border border-border p-3 md:grid-cols-6">
                ...
                <Input placeholder="CPF" value={d.cpf} onChange={(e) => updDep(d.id, { cpf: formatCpfPartial(e.target.value) })} onBlur={(ev) => updDep(d.id, { cpf: formatCpf(ev.currentTarget.value) })} />
